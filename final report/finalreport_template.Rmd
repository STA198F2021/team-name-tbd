...
```{r rsquared-age-gender, echo = FALSE, warning = FALSE, message = FALSE, fig.width=6}
...
```{r appendix-table6, echo = FALSE, message = FALSE, warning = FALSE, fig.width=6}
...
kable(appendix_table, caption = "\\textbf{Hypothesis Testing for Significance}", format = "latex") %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position")) %>%
  kable_styling(latex_options = c("striped", "hold_position"))

```

```{r appendix-table7, echo = FALSE, message = FALSE, warning = FALSE, out.width="10%"}
...
kable(appendix_table7, caption = "\\textbf{Linear Regression Model Significance}", format = "latex") %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"))
