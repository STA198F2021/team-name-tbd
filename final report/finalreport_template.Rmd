...
RSqu <- c(0.13472, 0.59600, 0.50689, 0.52935, 0.50549, 0.51491, 0.51617, 0.52610)

appendix_table7 <- data.frame(ModelNumber, RSqu, stringsAsFactors = FALSE)

kable(appendix_table7, caption = "\\textbf{Linear Regression Model R$^2$ Values}", format = "latex") %>%
  kable_styling(latex_options = c("striped", "hold_position"))
