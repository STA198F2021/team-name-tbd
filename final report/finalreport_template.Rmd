...
In this F-test (ndf = 18, ddf = 6031), a significant difference among age groups was identified. Our p-value tells us that this data (or data more extreme) would be very unlikely if the null hypothesis were true because it shows statistical significance at an alpha well below 0.05. Therefore, we reject the null hypothesis that the mean expenditures for all age groups are equal.
...
Analysis <- c("M/F Overall Spending", "M/F Public Spending", "M/F Private Spending", "M/F OoP Spending", "Overall Spending by Disease", "Overall Spending by Age")
