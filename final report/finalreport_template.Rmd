...
```{r distribution_pub, echo= FALSE, warning = FALSE, fig.height = 3, fig.width = 3, message = FALSE}
spending_malefemale %>%
...
```{r distribution_pri, echo= FALSE, warning = FALSE, fig.height = 3, fig.width = 3, message = FALSE}
spending_malefemale %>%
...
```{r distribution_oop, echo= FALSE, warning = FALSE, fig.height = 3, fig.width = 3, message = FALSE}
spending_malefemale %>%
